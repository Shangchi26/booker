<nav class="sticky top-0 z-50 px-4 py-4 flex justify-between items-center bg-white border-b">
        ...
        <div class="flex items-center gap-3">
            <div class="group inline-block relative">
                <h3 class="cursor-pointer">
                    Hello, {{ session('user.user_name') }}
                </h3>
                <ul
                    class="bg-white border rounded-sm transform scale-0 group-hover:scale-100 absolute right-0
  transition duration-150 ease-in-out origin-top w-32">
                    <li class="rounded-sm px-3 py-1 hover:bg-gray-100 cursor-pointer"><a href="/setting">Setting</a>
                    </li>
                    <li class="rounded-sm px-3 py-1 hover:bg-gray-100 cursor-pointer"><a href="/order">My Bookings</a>
                    </li>
                    <li class="rounded-sm px-3 py-1 hover:bg-gray-100 cursor-pointer"><a href="/logout">Logout</a></li>
                </ul>
            </div>
            <a class="relative scale-75" href="{{ route('cart') }}" data-bs-toggle="offcanvas"
                ...
                <span
                    class="absolute -top-2 left-4 rounded-full bg-red-500 p-0.5 px-2 text-sm text-red-50">{{ count(session('cart', [])) }}</span>
            </a>
        </div>
    @else
