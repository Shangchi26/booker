    ...
    <script>
        ...
        new Chart(count, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Booking Count',
                    data: [{{ $fiveMonthAgoCount }}, {{ $fourMonthAgoCount }}, {{ $threeMonthAgoCount }}, {{ $twoMonthAgoCount }}, {{ $lastMonthCount }}, {{ $monthBookingCount }}],
                    borderWidth: 1
                }]
            },
            options: {
    ...
    <script>
        ...
        new Chart(data, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Booking Data',
                    data: [{{ $fiveMonthAgoData }}, {{ $fourMonthAgoData }}, {{ $threeMonthAgoData }}, {{ $twoMonthAgoData }}, {{ $lastMonthData }}, {{ $monthData }}],
                    borderWidth: 1
                }]
            },
            options: {
